...
class LlamaExperiments:
    def run_experiment_gensim(self, instances=None, population_size=5, dataset_choice=1, seed=137,
                              mutation_tool=1, use_deep_seek=False) -> int:
        '''
        :param seed:
        ...
        if dataset_choice == 1:
            ...
            generated_testcases = human_eval_loader.get_generated_test_cases_llama()
